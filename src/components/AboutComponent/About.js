    ...
    render() {
        return (
            <div className="container p-5 shadow-lg overflow-auto" style={{ maxHeight: "1080px" }}>
                ...
                а так же просто перетащить его на форму.<br />Поддерживаемый формат: txt, csv, xlsx.<br />
                Файл может содержать: "Идентификатор адреса ; адрес" или только "Адрес"<br />
                Для текстовых файлов: возможная кодировка UTF-8 или windows-1251 (определяется автоматически), разделитель для столбцов: ";", заголовки не нужны<br />
                Для xlsx: заголовки обязательны, наименования неважны, порядок: идентификатор (если есть), адрес</p>
